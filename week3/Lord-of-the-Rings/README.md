...
If you need help remember all of the jQuery DOM commands, check out the [jQuery cheatsheet](https://git.generalassemb.ly/seir-9-21/student-resources/wiki/jQuery-Cheatsheet).
