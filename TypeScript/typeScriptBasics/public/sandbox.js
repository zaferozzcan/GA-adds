...
var myArray = ["charmender", "balbasaur"];
...
var mixed = []; // this enables us to initialize an empty array then we can push string and number types
mixed.push("hello");
mixed.push(20);
